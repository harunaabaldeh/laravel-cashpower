    ...
    <div class="content">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="card-body ">
                <div class="input-group no-border form-control-lg {{ $errors->has('msisdn') ? ' has-danger' : '' }}">
{{--                    <span class="input-group-prepend">--}}
{{--                    <div class="input-group-text">--}}
{{--                        <i class="now-ui-icons users_circle-08"></i>--}}
{{--                    </div>--}}
{{--                    </span>--}}
                    <input class="form-control {{ $errors->has('msisdn') ? ' is-invalid' : '' }}" placeholder="{{ __('mobile number') }}" id="msisdn" type="tel" name="msisdn" value="{{ old('msisdn') }}" required autofocus>
                    {!! Form::hidden('iso_code',null,['id'=>'iso_code']) !!}
{{--                    <input class="form-control {{ $errors->has('msisdn') ? ' is-invalid' : '' }}" placeholder="Your Mobile Number" type="tel" name="msisdn" value="{{ old('msisdn', null) }}" required autofocus>--}}
                </div>
...
{{--                    </div>--}}
                ...
                <button  type = "submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('Sign In') }}</button>
                <div class="pull-left">
                    <h6>
